...
CREATE TABLE IF NOT EXISTS knowledge_documents (
  ...
  document_type ENUM('pdf','docx','image','txt') NOT NULL,
  source_type ENUM('textbook','pyq','notes','mock_test','worksheet','reference_material') NOT NULL DEFAULT 'textbook',
  doc_class VARCHAR(20) DEFAULT NULL,
  doc_subject VARCHAR(80) DEFAULT NULL,
  doc_chapter VARCHAR(220) DEFAULT NULL,
  exam_type VARCHAR(80) DEFAULT NULL,
  year INT DEFAULT NULL,
  language VARCHAR(50) NOT NULL DEFAULT 'English',
  tags JSON DEFAULT NULL,
  extra_metadata JSON DEFAULT NULL,
  processing_status ENUM('queued','validating','extracting','parsing_layout','extracting_tables','extracting_images','chunking','deduplicating','embedding','completed','failed') NOT NULL DEFAULT 'queued',
  ...
  created_at DATETIME NOT NULL,
  updated_at DATETIME NOT NULL,
  UNIQUE KEY uq_knowledge_doc_hash (file_hash),
  ...
  INDEX ix_kd_uploaded_by (uploaded_by_id),
...
CREATE TABLE IF NOT EXISTS processing_jobs (
  ...
  status ENUM('pending','processing','completed','failed','retrying','dead_letter') NOT NULL DEFAULT 'pending',
