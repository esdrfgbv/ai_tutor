...
class Quiz(Base, TimestampMixin):
    ...
    scheduled_date: Mapped[datetime | None] = mapped_column(DateTime, default=None)
    total_marks: Mapped[int | None] = mapped_column(Integer, default=None)
...
class StudyPlan(Base, TimestampMixin):
    """Persistent weekly study plan generated by AI or rules."""
    __tablename__ = "study_plans"
    __table_args__ = (Index("ix_study_plan_student_active", "student_id", "is_active"),)
    ...
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    generated_by: Mapped[str] = mapped_column(String(20), default="rule", nullable=False)
